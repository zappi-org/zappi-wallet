...
import { DexiePaymentAliasPendingQuotesRepository } from '@/adapters/storage/dexie/dexie-payment-alias-pending-quotes.repository'
...
export function assembleNpubcashWatcher(deps: {
  ...
  const pendingQuotesRepo = new DexiePaymentAliasPendingQuotesRepository()
