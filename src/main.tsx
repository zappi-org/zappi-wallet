...
function renderStorageBlocked() {
  ...
  root.innerHTML = `
    <div style="min-height: 100vh; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 24px; text-align: center; background: #0a0a0a; color: #fafafa;">
      <div style="font-size: 48px; margin-bottom: 16px;">⚠️</div>
      <h1 style="font-size: 24px; font-weight: bold; margin-bottom: 8px;">Storage Unavailable</h1>
      <p style="color: #a1a1aa; max-width: 320px; line-height: 1.5;">
