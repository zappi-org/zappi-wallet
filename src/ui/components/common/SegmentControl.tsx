...
export function SegmentControl<T extends string>({
  ...
  return (
    <div className={cn('relative flex p-[3px] bg-foreground/[0.06] rounded-xl', className)}>
      {/* Sliding indicator */}
      <div
        className="absolute top-[3px] bottom-[3px] bg-background-card rounded-lg shadow-sm transition-transform duration-200 ease-out"
        style={{
