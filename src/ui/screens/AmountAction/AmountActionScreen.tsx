 ...
 * Provides 2 buttons (Send/Receive) that expand to show Lightning/Ecash options
 */
  ...
  return (
    <div className="h-dvh bg-background text-foreground font-sans flex flex-col pt-safe pb-safe">
      ...
      <header className="flex items-center justify-between px-4 py-3 border-b border-border-visible">
        ...
        <h1 className="text-lg font-semibold">{t('amountAction.title')}</h1>
        <div className="w-9" />
      </header>
      ...
      >
        ...
        {/* Action Buttons - Vertical Stack when expanded */}
        <div
          ref={containerRef}
