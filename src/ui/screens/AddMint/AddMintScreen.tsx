    ...
    return (
      <div className="h-dvh bg-background text-foreground flex flex-col pt-safe pb-safe z-[60]">
        ...
        <header className="flex items-center gap-3 px-4 pt-4 pb-3 border-b border-border">
          ...
          <h2 className="text-body font-semibold tracking-tight flex-1 text-center">{t('addMint.title')}</h2>
          <div className="w-7" />
        </header>
  ...
  return (
    <div className="animate-slideInUp h-dvh bg-background text-foreground flex flex-col font-sans relative overflow-hidden z-[60] pt-safe">
      ...
      <div className="flex-1 overflow-y-auto">
        <p className="text-overline uppercase tracking-wide text-foreground-muted px-4 pt-3 pb-2">
          {t('addMint.worldwide')}
        </p>
        ...
        {isLoadingDiscovery ? (
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-label text-foreground-muted">{t('addMint.loading')}</p>
          </div>
        ) : discoveryError ? (
          <div className="flex flex-col items-center justify-center py-12">
                ...
                >
                  ...
                  {!isAlreadyAdded && !isAtLimit && (
                    <button
                      ...
                      className="w-8 h-8 flex items-center justify-center rounded-xl bg-foreground/[0.06] active:bg-foreground/15 shrink-0"
                    >
