...
export function MyAddressScreen({ onBack, onSaveSettings }: MyAddressScreenProps) {
  ...
  const displayAddress = lightningAddress ?? (cache?.address ?? null)
                      ...
                      {mintUrl ? (
                        <div className="mt-2 flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="ml-1 flex h-[26px] w-[50px] shrink-0 items-center justify-center gap-1 rounded-[7px] border border-neutral-300 bg-background-card text-[9px] text-foreground active:scale-95 motion-reduce:active:scale-100 transition-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand/40"
                          >
