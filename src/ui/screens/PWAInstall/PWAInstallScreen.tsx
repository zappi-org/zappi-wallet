    ...
    <div className="space-y-4">
      <div className="flex items-start gap-3 p-3 bg-background-card rounded-lg">
        <div className="w-8 h-8 bg-accent-primary/20 rounded-lg flex items-center justify-center flex-shrink-0">
          <span className="text-subtitle font-semibold">1</span>
        </div>
        <div>
          <p className="font-medium mb-1">{t('pwa.iosShareButton')}</p>
          <div className="flex items-center gap-2 text-muted-foreground">
            <ShareIcon />
            <span className="text-label font-medium">{t('pwa.iosFindIcon')}</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-start gap-3 p-3 bg-background-card rounded-lg">
        <div className="w-8 h-8 bg-accent-primary/20 rounded-lg flex items-center justify-center flex-shrink-0">
          <span className="text-subtitle font-semibold">2</span>
        </div>
        <div>
          <p className="font-medium mb-1">{t('pwa.iosAddToHome')}</p>
          <div className="flex items-center gap-2 text-muted-foreground">
            <PlusSquareIcon />
            <span className="text-label font-medium">{t('pwa.iosScrollFind')}</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-start gap-3 p-3 bg-background-card rounded-lg">
        <div className="w-8 h-8 bg-accent-primary/20 rounded-lg flex items-center justify-center flex-shrink-0">
          <span className="text-subtitle font-semibold">3</span>
        </div>
        <div>
    ...
    <div className="space-y-4">
      <div className="flex items-start gap-3 p-3 bg-background-card rounded-lg">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 text-muted-foreground">
            <MenuIcon />
            <span className="text-label font-medium">{t('pwa.androidMenuIcon')}</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-start gap-3 p-3 bg-background-card rounded-lg">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 text-muted-foreground">
            <DownloadIcon />
            <span className="text-label font-medium">{t('pwa.androidFindInMenu')}</span>
          </div>
        </div>
      </div>
    ...
    <div className="space-y-4">
      <div className="flex items-start gap-3 p-3 bg-background-card rounded-lg">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 text-muted-foreground">
            <DownloadIcon />
            <span className="text-label font-medium">{t('pwa.desktopOrMenu')}</span>
          </div>
        </div>
      </div>
      ...
      <p className="text-label font-medium text-muted-foreground text-center">
      ...
      <div className="flex-1 flex flex-col items-center justify-center text-center">
        ...
        <div className="w-full max-w-sm">
          <div className="p-4 bg-background-card rounded-xl mb-4">
            ...
            <p className="text-muted-foreground text-label font-medium whitespace-pre-line">
