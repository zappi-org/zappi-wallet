export default {
  ...
  pos: {
    ...
    waitingPayment: '支払い待ち中...',
    paymentComplete: '支払い完了!',
    nextPayment: '次の支払い',
    exitPosMode: 'POSモード終了',
    lightningReceive: 'Lightning受け取り',
    ecashReceive: 'Ecash受け取り',
    ...
    nfc: 'NFC',
    wave: 'Wave',
    invoiceExpired: 'インボイスの有効期限が切れました。もう一度お試しください。',
    ...
    tokenReceiveFailed: 'トークンの受け取りに失敗しました。',
    tokenProcessError: 'トークン処理中にエラーが発生しました。',
    mintTrustAddFailed: 'ミント信頼の追加に失敗しました。',
    untrustedMint: '信頼されていないミント',
    addMintTrustQuestion: 'このミントを信頼リストに追加しますか?',
    addingTrust: '追加中...',
    trustMint: 'ミントを信頼',
    reEnter: '再入力',
    qrScanError: 'QRスキャンエラー',
    scanOrPasteToken: 'QRコードをスキャンまたはトークンを貼り付け',
    comingSoon: '近日公開',
    nfcComingSoon: 'NFCによるecash受信機能は近日公開予定です',
    waveComingSoon: '音波によるecash受信機能は近日公開予定です',
  },
  ...
  kiosk: {
    ...
    creatingInvoice: 'インボイス作成中...',
    paymentAmount: '支払い金額',
    scanWithLightning: 'LightningウォレットでQRコードをスキャン',
    paymentComplete: '支払い完了!',
    thankYou: 'ありがとうございます。',
    totalPaymentAmount: '合計支払い金額',
    placeOrder: '注文する',
    pleaseWait: 'しばらくお待ちください...',
    cancelOrNewOrder: 'キャンセル / 新規注文',
    selectPaymentMethod: 'お支払い方法を選択',
    payWithLightning: 'Lightningで支払う',
    payWithEcash: 'Ecashで支払う',
    creatingRequest: '決済リクエスト作成中...',
    scanWithEcash: 'EcashウォレットでQRコードをスキャン',
    waitingEcash: 'Ecash決済を待っています...',
    start: '開始',
    clearCart: 'カートを空にする',
    upload: 'アップロード',
    enterImageUrl: '画像URLを入力',
    productNamePlaceholder: '例: アメリカーノ',
    priceSats: '価格 (sats)',
    category: 'カテゴリー',
    none: 'なし',
    createNew: '新規作成',
    ...
    enterValidPrice: '正しい価格を入力してください。',
    adminUnlock: '管理者ロック解除',
    authFailed: '認証に失敗しました。',
    wrongPin: 'PINが間違っています。',
    biometricUnlock: '生体認証でロック解除',
    useBiometric: '生体認証を使用してください',
    enterPin: 'PINで入力',
    unlockAction: 'ロック解除',
    switchToBiometric: '生体認証に切り替え',
    noProductsGuide: 'まもなく商品が準備されます',
  },
