export default {
  chat: {
    selfAddress: '自分のアドレスとはチャットを開始できません。',
    openFailed: '会話を開けませんでした。再試行してください。',
    myAddress: '自分のアドレス',
    storageUnavailable: "チャットを開けません。ウォレットをロックして再度解除してください。",
    paymentCard: {
      receivedRequest: '送金リクエストが届きました',
      receiving: '入金処理中',
      checkingPayment: '送金履歴を確認中',
      receiveFailed: '入金できませんでした',
      pay: '送る',
      requested: '送金をリクエストしました',
      alreadySent: 'このリクエストにはすでに送金しています。',
      requestTo: "{{name}}さんへのリクエスト",
      requestFrom: "{{name}}さんからのリクエスト",
      paymentTo: "{{name}}さんへの送金",
      paymentFrom: "{{name}}さんからの送金",
      awaitingReceipt: "相手の受取待ち",
      noticeFailed: "送金通知を保存できませんでした。取引履歴を確認してください。",
      "requestTitle": "送金リクエスト",
      "sendTitle": "送金",
      "noticeTitle": "送金のお知らせ",
      "openAmount": "金額未指定",
      "received": "受取確認済み",
      ...
      "opening": "開いています…",
      details: "取引履歴",
      openFailed: "送金画面を開けませんでした。もう一度お試しください。",
},
    storageFull: "チャットの保存容量が上限に達しました。古い会話を削除して再試行してください。",
    receiveFull: "未受信のメッセージがあります。再読み込みしてください。",
    contextLabel: "取引 {{id}}",
    deleteConversation: '会話を削除',
    sendMoney: '送金する',
    blockDescription: "この相手からの新しいメッセージと通知をブロックします。",
    "title": "チャット",
    "newChat": "新しいチャット",
    "search": "会話を検索",
    "all": "すべて",
    ...
    "noResults": "会話が見つかりません",
    "start": "チャット開始",
    "sayHello": "最初のメッセージを送りましょう。",
    "draft": "下書き",
    "actions": "会話メニュー",
    "pin": "固定",
    "unpin": "固定を解除",
    ...
    "block": "ブロック",
    "unblock": "ブロック解除",
    "blockedContacts": "ブロック中の相手",
    "blocked": "返信するにはチャット一覧でブロックを解除してください。",
    "deleteTitle": "会話を削除しますか？",
    "deleteDescription": "この端末のメッセージを削除します。相手やリレーのコピーは削除されません。",
    "saveFailed": "保存できませんでした。再試行してください。",
    "loadFailed": "メッセージを読み込めません",
    "invalidAddress": "自分以外の有効なNostrアドレスを入力してください。",
    newMessage: "新しいメッセージ",
    sendFailed: "送信できませんでした。再試行してください。",
    "paymentRequest": "支払いリクエスト",
    "encrypted": "エンドツーエンド暗号化",
    unknownContact: "連絡先に追加",
    "older": "以前のメッセージ",
    "newMessages": "新着メッセージ",
    "sent": "リレーに送信済み",
    "sending": "送信中",
    "request": "リクエスト",
    "paymentActions": "送金・支払いリクエスト",
