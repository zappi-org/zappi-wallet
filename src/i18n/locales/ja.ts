export default {
  ...
  support: {
    ...
    heroDescription: 'Zappiチームに安全にお問い合わせを送り、ここで回答を受け取れます。',
    connectionStatus: {
      disabled: '無効',
      idle: '待機中',
      connecting: '接続中',
    ...
    connecting: 'お問い合わせ履歴を読み込み中',
    connectingDescription: 'しばらくお待ちください。',
    connectionFailed: 'お問い合わせチャンネルに接続できませんでした',
    tryAgainLater: 'しばらくしてからもう一度お試しください。',
    newTicket: '新規お問い合わせ',
    startNewTicket: 'お問い合わせ',
    composePageTitle: 'お問い合わせ',
    requestTitleLabel: 'タイトル',
    requestBodyLabel: '内容',
    titlePlaceholder: 'タイトルを入力してください',
    bodyPlaceholder: 'お問い合わせ内容を入力してください',
    privacyNote: 'リカバリーフレーズや秘密鍵は入力しないでください。',
    categoryLabel: '種類',
    priorityLabel: '優先度',
    categories: {
      transfer: '送金・受け取り',
    ...
    categoryDescriptions: {
      transfer: 'ライトニング / イーキャッシュの送受信について',
      ecash: 'イーキャッシュの登録・復元について',
      fee: '手数料やルーティングコストについて',
      security: 'ロック、バックアップ、リカバリーフレーズについて',
      other: 'その他のお問い合わせ',
    },
    priorities: {
      normal: '通常',
    ...
    teamName: 'Zappiチーム',
    attachmentPreview: '添付ファイル{{count}}件',
    attachFile: 'ファイルを添付',
    ...
    downloadingAttachment: 'ダウンロード中',
    filePreview: 'ファイルを送信しました。',
    replyToast: '「{{title}}」に回答が届きました。',
    ticketActions: 'お問い合わせオプション',
    pinTicket: 'ピン留め',
    unpinTicket: 'ピン留め解除',
    markRead: '既読にする',
    leaveTicket: '退出',
    ...
    resolvedNotice: 'このお問い合わせは解決済みです。',
    closedNotice: 'このお問い合わせは終了しました。',
    status: {
      open: '受付',
      in_progress: '対応中',
      resolved: '解決済み',
  ...
  settings: {
    ...
    tlsBolt11Send: 'Bolt11送信（melt）',
    tlsBolt11Receive: 'Bolt11受信（minting）',
    tlsEcashCreate: 'イーキャッシュ作成',
    tlsEcashRedeem: 'イーキャッシュ登録',
    tlsGiftWrap: 'GiftWrapで受信',
    tlsCreq: 'Creqで受信',
    ...
    currentWalletRecoveryDesc: 'このウォレットのリカバリーフレーズで作成されたeCashを探します。',
    externalMnemonicRecovery: '別のリカバリーフレーズのeCashを取り込む',
    externalMnemonicRecoveryDesc: '別のリカバリーフレーズで見つかったeCashを現在のウォレットへ移します。',
  ...
  send: {
    ...
    destination: {
      ...
      whoToSend: '誰に送りますか？',
      placeholder: 'アドレスまたはインボイスを入力',
      hint: '<b>ライトニングアドレス</b>、<b>インボイス</b>、<b>Cashu リクエスト</b>を貼り付けるかスキャンできます',
