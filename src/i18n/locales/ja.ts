export default {
  ...
  settings: {
    ...
    invalidLightningFormat: '無効な形式です。（例: user@domain.com）',
    lightningVerifyFailed: 'Lightningアドレスを確認できませんでした。',
    invalidLightningAddress: '無効なLightningアドレスです。',
    lightningValidationError: 'Lightningアドレスの検証に失敗しました。',
  ...
  errors: {
    ...
    insufficientBalance: '残高が不足しています（必要: {{required}} sats、保有: {{available}} sats）',
