export default {
  ...
  common: {
    ...
    loading: '読み込み中...',
    error: 'エラー',
    walletLoadErrorTitle: 'ウォレットを読み込めませんでした',
    walletLoadErrorDescription: '既存のウォレットを保護するため、新しいウォレット作成には進みませんでした。しばらくしてからもう一度お試しください。',
    success: '成功',
    retry: '再試行',
    skip: 'スキップ',
    no: 'ないです',
  ...
  settings: {
    ...
    currentWalletRecoveryDesc: 'このウォレットのニーモニックで作成されたeCashを探します。',
    externalMnemonicRecovery: '別のニーモニックのeCashを取り込む',
    externalMnemonicRecoveryDesc: '別のニーモニックで見つかったeCashを現在のウォレットへ移します。',
    externalMnemonicRecoveryWarning: '入力したニーモニックは保存されません。登録済みミントで見つかったeCashだけを現在のウォレットへ移します。',
    externalMnemonicPlaceholder: 'スキャンするニーモニックを入力',
    externalMnemonicRequired: 'ニーモニックを入力してください。',
  ...
  txDetail: {
    ...
    outgoingStatus: {
      waitingClaim: '受領待ち',
      publishedWaitingClaim: '送信済み · 受領待ち',
      claimed: '受領完了',
      reclaimed: '回収完了',
      publishFailed: '送信失敗',
      checkFailed: '状態確認失敗',
  ...
  errors: {
    ...
    serviceNotReady: '準備中です。しばらくしてからもう一度お試しください',
  ...
  send: {
    ...
    tokenCreate: {
      ...
      confirmTitle: '作成の確認',
      confirmQuestion: '<from><b>{{mint}}</b>から</from><b>{{amount}}</b>の\nイーキャッシュを作りますか？',
    ...
    confirm: {
      ...
      fullQuestion: '<from><b>{{mint}}</b>から</from>\n<to><b>{{recipient}}</b>へ</to>\n{{amount}}を\n送りますか？',
      fullTransferQuestion: '<from><b>{{mint}}</b>から</from>\n<to><b>{{target}}</b>へ</to>\n{{amount}}を\n移動しますか？',
      feeEstimateFailed: '手数料を確認できません',
      toSuffix: 'に',
      recipientTo: '<to><b>{{recipient}}</b>に</to>',
      amountSuffix: 'を',
      questionEnd: '送りますか？',
    ...
    sending: {
      ...
      inProgress: '送金中です...',
      fullMessage: '<to><b>{{recipient}}</b>へ</to>\n{{amount}}を\n送金中です...',
