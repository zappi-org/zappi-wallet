export default {
  ...
  settings: {
    ...
    claimStorageTitle: '期限切れ時に自動保存',
    claimStorageDesc: '見積もりが期限切れになる前にecashを自動的に保存します',
    claimStorageEnabled: '自動保存 有効',
    claimStorageDisabled: '自動保存 無効',
    claimStorageStoredBalance: '保存済みEcash',
    claimNow: '保存',
    claimSuccess: '{{count}}件のトークンを保存しました',
    claimFailed: '保存に失敗しました',
    security: 'セキュリティ',
