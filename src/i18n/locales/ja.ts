export default {
  ...
  settings: {
    ...
    changeUsername: 'ライトニング/ノスターアドレスを変更',
    currentAddress: '現在のアドレス',
    newUsername: '新しいユーザー名',
    usernameAvailable: '利用可能',
    usernameTaken: '既に使用中',
    usernameInvalid: '3〜20文字、小文字と数字のみ',
    usernameLabel: 'ユーザーアドレス',
    usernameSameAddress: '現在のアドレスと同じです',
    changeFee: '変更手数料',
    insufficientBalance: '残高が不足しています',
    usernameChanged: 'ユーザー名が変更されました',
    usernameChangeFailed: 'ユーザー名の変更に失敗しました',
    changingUsername: '変更中...',
    changeConfirmTitle: '変更の確認',
    newAddressLabel: '新しいユーザーアドレス',
    successAddressLabel: '新しいアドレス',
    changeDone: '変更が完了しました',
    changeIrreversible: '変更後は返金できません。慎重にお決めください。',
    pay: '支払う',
    paymentMint: '支払いミント',
