export default {
  ...
  settings: {
    ...
    noMint: 'No configurado',
    mintChanged: 'Mint actualizado',
    mintChangeFailed: 'Error al actualizar mint',
    ...
    claimStorageTitle: 'Auto-guardado al expirar',
    claimStorageDesc: 'Guardar ecash automáticamente antes de que caduquen las cotizaciones',
    claimStorageEnabled: 'Auto-guardado activado',
    claimStorageDisabled: 'Auto-guardado desactivado',
    claimStorageStoredBalance: 'Ecash almacenado',
    claimNow: 'Guardar',
    claimSuccess: '{{count}} token(s) guardados',
    claimFailed: 'Error al guardar',
    security: 'Seguridad',
