export default {
  ...
  settings: {
    ...
    invalidLightningFormat: 'Formato inválido. (ej: user@domain.com)',
    lightningVerifyFailed: 'No se pudo verificar la dirección Lightning.',
    invalidLightningAddress: 'Dirección Lightning inválida.',
    lightningValidationError: 'Error al validar la dirección Lightning.',
  ...
  errors: {
    ...
    insufficientBalance: 'Saldo insuficiente (necesario: {{required}} sats, disponible: {{available}} sats)',
