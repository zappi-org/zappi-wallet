export default {
  ...
  settings: {
    ...
    myAddressDesc: 'Ver tus direcciones Lightning y Nostr',
    ...
    mintChanged: 'Mint actualizado',
    mintChangeFailed: 'No se pudo cambiar el mint',
    changeUsername: 'Cambiar dirección Lightning/Nostr',
    ...
    usernameLabel: 'Dirección de usuario',
    usernameSameAddress: 'Ya es la dirección actual',
    changeFee: 'Comisión de cambio',
    insufficientBalance: 'Saldo insuficiente',
    usernameChanged: 'Usuario cambiado',
    usernameChangeFailed: 'Error al cambiar el usuario',
    changingUsername: 'Cambiando...',
    changeConfirmTitle: 'Confirmar cambio',
    newAddressLabel: 'Nueva dirección de usuario',
    successAddressLabel: 'Nueva dirección',
    changeDone: 'El cambio se ha completado',
    changeIrreversible: 'Este cambio no es reembolsable. Decide con cuidado.',
    pay: 'Pagar',
    ...
    mintShortBadge: '{{amount}} insuficientes',
    mintShortReason: 'Este mint no puede cubrir la tarifa ({{amount}} insuficientes). Selecciona otro mint.',
