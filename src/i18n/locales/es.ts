export default {
  chat: {
    selfAddress: 'No puedes iniciar un chat con tu propia dirección.',
    openFailed: 'No se pudo abrir la conversación. Inténtalo de nuevo.',
    myAddress: 'Mi dirección',
    storageUnavailable: "No se pudo abrir el chat. Bloquea y desbloquea la billetera.",
    paymentCard: {
      receivedRequest: 'Recibiste una solicitud de pago',
      receiving: 'Recibiendo el pago',
      checkingPayment: 'Comprobando el pago',
      receiveFailed: 'No se pudo recibir el pago',
      pay: 'Enviar',
      requested: 'Pago solicitado',
      alreadySent: 'Ya enviaste este pago.',
      requestTo: "Solicitud a {{name}}",
      requestFrom: "Solicitud de {{name}}",
      paymentTo: "Pago a {{name}}",
      paymentFrom: "Pago de {{name}}",
      awaitingReceipt: "Pendiente de recepción",
      noticeFailed: "No se guardó el aviso. Revisa las transacciones.",
      "requestTitle": "Solicitud de pago",
      "sendTitle": "Pago",
      "noticeTitle": "Aviso de pago",
      "openAmount": "Importe sin especificar",
      "received": "Pago recibido",
      "sent": "Pago enviado",
      "processing": "Pago en curso",
      notice: "Comprobando la recepción",
      "failed": "Pago fallido",
      "expired": "Caducado",
      "cancelled": "Cancelado",
      "expires": "Caduca",
      ...
      openFailed: "No se pudo abrir la pantalla de pago. Inténtalo de nuevo.",
},
    storageFull: "El almacenamiento de chat está lleno. Elimina conversaciones antiguas e inténtalo de nuevo.",
    receiveFull: "Faltan mensajes por recibir. Vuelve a cargar.",
    contextLabel: "Operación {{id}}",
    deleteConversation: 'Eliminar conversación',
    sendMoney: 'Enviar dinero',
    blockDescription: "Bloquea mensajes nuevos y notificaciones de esta persona.",
    "title": "Mensajes",
    ...
    "noResults": "No hay conversaciones",
    "start": "Iniciar chat",
    "sayHello": "Saluda para iniciar la conversación.",
    "draft": "Borrador",
    "actions": "Opciones de conversación",
    "pin": "Fijar",
    "unpin": "Desfijar",
    "mute": "Silenciar",
    ...
    "block": "Bloquear",
    "unblock": "Desbloquear",
    "blockedContacts": "Remitentes bloqueados",
    "blocked": "Desbloquea al remitente desde Mensajes para responder.",
    "deleteTitle": "¿Eliminar conversación?",
    "deleteDescription": "Se eliminarán los mensajes de este dispositivo. Las copias del destinatario y de los relés permanecerán.",
    "saveFailed": "No se pudo guardar. Inténtalo de nuevo.",
    "loadFailed": "No se pudieron cargar los mensajes",
    "invalidAddress": "Introduce una dirección Nostr válida distinta de la tuya.",
    newMessage: "Nuevo mensaje",
    sendFailed: "Mensaje no enviado. Inténtalo de nuevo.",
    "paymentRequest": "Solicitud de pago",
    "encrypted": "Cifrado de extremo a extremo",
    unknownContact: "Añadir a contactos",
    "older": "Cargar mensajes anteriores",
    "newMessages": "Mensajes nuevos",
    "sent": "Enviado al relé",
    "sending": "Enviando",
    "request": "Solicitar",
    "paymentActions": "Enviar o solicitar dinero",
  ...
  send: {
    ...
    confirm: {
      ...
      feeUnavailable: "No se pudo consultar la comisión.",
      retryFee: 'Reintentar',
      total: 'Total',
      send: 'Enviar',
