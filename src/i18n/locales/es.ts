export default {
  ...
  common: {
    ...
    loading: 'Cargando...',
    error: 'Error',
    walletLoadErrorTitle: 'No se pudo cargar la billetera',
    walletLoadErrorDescription: 'Para proteger tu billetera existente, Zappi no continuó con la configuración de una billetera nueva. Inténtalo de nuevo en unos momentos.',
    success: 'Éxito',
    retry: 'Reintentar',
    skip: 'Omitir',
    no: 'No',
  ...
  settings: {
    ...
    verifyBalance: 'Revisar y recuperar billetera',
  ...
  history: {
    ...
    npubReceive: 'Recibir (npub)',
    npubSend: 'Enviar (npub)',
  ...
  txDetail: {
    ...
    outgoingStatus: {
      waitingClaim: 'Esperando reclamación',
      publishedWaitingClaim: 'Enviado · esperando reclamación',
      claimed: 'Reclamado',
      reclaimed: 'Recuperado',
      publishFailed: 'Error de envío',
      checkFailed: 'Error al verificar estado',
    },
  ...
  errors: {
    ...
    serviceNotReady: 'Todavía se está preparando. Inténtalo de nuevo en breve.',
