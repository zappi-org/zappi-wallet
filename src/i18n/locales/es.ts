export default {
  ...
  pos: {
    ...
    exitPosMode: 'Salir del modo POS',
    lightningReceive: 'Recibir Lightning',
    ecashReceive: 'Recibir Ecash',
    ...
    nfc: 'NFC',
    wave: 'Wave',
    invoiceExpired: 'La factura ha expirado. Inténtalo de nuevo.',
    invoiceCreateFailed: 'Error al crear la factura.',
    invoiceCreateError: 'Ocurrió un error al crear la factura.',
    mintOfflineWarning: 'El mint está offline. Este token no está protegido con P2PK, alguien más podría usarlo primero. Inténtalo cuando el mint esté online.',
    tokenReceiveFailed: 'Error al recibir el token.',
    tokenProcessError: 'Ocurrió un error al procesar el token.',
    mintTrustAddFailed: 'Error al agregar confianza al mint.',
    untrustedMint: 'Mint no confiable',
    addMintTrustQuestion: '¿Agregar este mint a tu lista de confianza?',
    addingTrust: 'Agregando...',
    trustMint: 'Confiar en Mint',
    reEnter: 'Reingresar',
    qrScanError: 'Error de escaneo QR',
    scanOrPasteToken: 'Escanea código QR o pega el token',
  ...
  kiosk: {
    ...
    scanWithLightning: 'Escanea el código QR con tu billetera Lightning',
    paymentComplete: '¡Pago completado!',
    thankYou: 'Gracias.',
    totalPaymentAmount: 'Total a pagar',
    placeOrder: 'Realizar pedido',
    pleaseWait: 'Por favor espera...',
    cancelOrNewOrder: 'Cancelar / Nuevo pedido',
    selectPaymentMethod: 'Seleccionar método de pago',
    payWithLightning: 'Pagar con Lightning',
    payWithEcash: 'Pagar con Ecash',
    creatingRequest: 'Creando solicitud de pago...',
    scanWithEcash: 'Escanea el código QR con tu billetera Ecash',
    waitingEcash: 'Esperando pago Ecash...',
    start: 'Iniciar',
    clearCart: 'Vaciar carrito',
    upload: 'Subir',
    enterImageUrl: 'Ingresa URL de imagen',
    productNamePlaceholder: 'Ej: Americano',
    priceSats: 'Precio (sats)',
    category: 'Categoría',
    none: 'Ninguna',
    createNew: 'Crear nueva',
    newCategoryName: 'Nombre de nueva categoría',
    imageSizeLimit: 'El tamaño de la imagen debe ser 5MB o menos.',
    enterProductName: 'Por favor ingresa el nombre del producto.',
    enterValidPrice: 'Por favor ingresa un precio válido.',
    adminUnlock: 'Desbloqueo admin',
    authFailed: 'Autenticación fallida.',
    wrongPin: 'PIN incorrecto.',
    biometricUnlock: 'Desbloquear con biometría',
    useBiometric: 'Usa autenticación biométrica',
    enterPin: 'Ingresar PIN',
    unlockAction: 'Desbloquear',
    switchToBiometric: 'Cambiar a biometría',
    noProductsGuide: 'Los artículos estarán disponibles pronto',
  },
