export default {
  ...
  common: {
    ...
    loading: '로딩 중...',
    error: '오류',
    walletLoadErrorTitle: '지갑을 불러오지 못했습니다',
    walletLoadErrorDescription: '기존 지갑을 보호하기 위해 새 지갑 만들기로 넘어가지 않았습니다. 잠시 후 다시 시도해주세요.',
    success: '성공',
    retry: '다시 시도',
    skip: '건너뛰기',
    no: '없어요',
  ...
  support: {
    ...
    heroDescription: 'Zappi 팀에 안전하게 문의를 남기고 답변을 받을 수 있습니다.',
    connectionStatus: {
      disabled: '비활성',
      idle: '대기 중',
      connecting: '연결 중',
    ...
    connecting: '문의 내역을 불러오는 중',
    connectingDescription: '잠시만 기다려주세요.',
    ...
    createTicket: '등록하기',
    sending: '보내는 중...',
    sendingToRelay: '문의 등록 중입니다.',
    submittingTicket: '문의 등록 중입니다.',
    sendingMessage: '메시지를 보내는 중입니다.',
    createFailed: '문의를 보내지 못했습니다',
    sendFailed: '메시지를 보내지 못했습니다',
    updateFailed: '문의 내역을 변경하지 못했습니다',
    ...
    sendMessage: '메시지 보내기',
    teamName: 'Zappi team',
    attachmentPreview: '첨부파일 {{count}}개',
    attachFile: '파일 첨부',
    ...
    downloadingAttachment: '다운로드 중',
    filePreview: '파일을 보냈습니다.',
    ...
    resolvedNotice: '문의가 해결되었습니다.',
    closedNotice: '문의가 종료되었습니다.',
    status: {
      open: '접수',
      in_progress: '처리 중',
      resolved: '해결됨',
  ...
  txDetail: {
    ...
    outgoingStatus: {
      waitingClaim: '수령 대기',
      publishedWaitingClaim: '전송됨 · 수령 대기',
      claimed: '수령 완료',
      reclaimed: '회수 완료',
      publishFailed: '전송 실패',
  ...
  errors: {
    ...
    serviceNotReady: '아직 준비 중입니다. 잠시 후 다시 시도해주세요',
  ...
  send: {
    ...
    tokenCreate: {
      ...
      confirmTitle: '생성 확인',
      confirmQuestion: '<from><b>{{mint}}</b>에서</from> <b>{{amount}}</b>\n이캐시를 만들까요?',
    ...
    confirm: {
      ...
      toSuffix: '에게',
      recipientTo: '<to><b>{{recipient}}</b>에게</to>',
      amountSuffix: '을',
      questionEnd: '보낼까요?',
      fullQuestion: '<from><b>{{mint}}</b>에서</from>\n<to><b>{{recipient}}</b>에게</to>\n{{amount}}을\n보낼까요?',
      fullTransferQuestion: '<from><b>{{mint}}</b>에서</from>\n<to><b>{{target}}</b>으로</to>\n{{amount}}을\n옮길까요?',
      method: '전송 방식',
      sourceMint: '출금 지갑',
      recipient: '받는이',
      memo: '메모',
    ...
    sending: {
      ...
      inProgress: '보내는 중이에요...',
      fullMessage: '<to><b>{{recipient}}</b>에게</to>\n{{amount}}을\n보내는 중이에요...',
