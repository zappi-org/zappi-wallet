export default {
  ...
  pos: {
    ...
    waitingPayment: '결제 대기중...',
    paymentComplete: '결제 완료!',
    nextPayment: '다음 결제',
    exitPosMode: 'POS 모드 종료',
    lightningReceive: 'Lightning 받기',
    ecashReceive: 'Ecash 받기',
    ...
    untrustedMint: '신뢰하지 않는 민트입니다',
    addMintTrustQuestion: '이 민트를 신뢰 목록에 추가하시겠습니까?',
    addingTrust: '추가 중...',
    trustMint: '민트 신뢰하기',
    reEnter: '다시 입력',
    qrScanError: 'QR 스캔 오류',
    scanOrPasteToken: 'QR 코드를 스캔하거나 토큰을 붙여넣으세요',
    comingSoon: 'Coming Soon',
    nfcComingSoon: 'NFC를 통한 ecash 수신 기능이 곧 추가될 예정입니다',
    waveComingSoon: '음파를 통한 ecash 수신 기능이 곧 추가될 예정입니다',
  },
  ...
  kiosk: {
    ...
    creatingInvoice: '인보이스 생성 중...',
    paymentAmount: '결제 금액',
    scanWithLightning: 'Lightning 지갑으로 QR 코드를 스캔하세요',
    paymentComplete: '결제 완료!',
    thankYou: '감사합니다.',
    totalPaymentAmount: '총 결제 금액',
    placeOrder: '주문하기',
    pleaseWait: '잠시만 기다려주세요...',
    cancelOrNewOrder: '취소 / 새 주문',
    selectPaymentMethod: '결제 수단 선택',
    payWithLightning: 'Lightning 결제',
    payWithEcash: 'Ecash 결제',
    creatingRequest: '결제 요청 생성 중...',
    scanWithEcash: 'Ecash 지갑으로 QR 코드를 스캔하세요',
    waitingEcash: 'Ecash 결제 대기 중...',
    start: '시작',
    clearCart: '장바구니 비우기',
    upload: '업로드',
    enterImageUrl: '이미지 URL을 입력하세요',
    productNamePlaceholder: '예: 아메리카노',
    priceSats: '가격 (sats)',
    category: '카테고리',
    none: '없음',
    createNew: '새로 만들기',
    ...
    enterProductName: '상품명을 입력해주세요.',
    enterValidPrice: '올바른 가격을 입력해주세요.',
    adminUnlock: '관리자 잠금 해제',
    authFailed: '인증에 실패했습니다.',
    wrongPin: 'PIN이 틀렸습니다.',
    biometricUnlock: '생체 인증으로 잠금 해제',
    useBiometric: '생체 인증을 사용하세요',
    enterPin: 'PIN으로 입력',
    unlockAction: '잠금 해제',
    switchToBiometric: '생체 인증으로 전환',
    noProductsGuide: '잠시 후 상품이 준비됩니다',
  },
  ...
  errors: {
    ...
    insufficientBalance: '잔액이 부족합니다 (필요: {{required}} sats, 보유: {{available}} sats)',
