export default {
  ...
  settings: {
    ...
    changeConfirmTitle: '변경 확인',
    newAddressLabel: '새 사용자 주소',
    successAddressLabel: '새 주소',
    changeDone: '변경이 완료되었어요',
    changeIrreversible: '변경 이후 환불이 불가해요. 신중히 결정해주세요.',
    pay: '결제',
    paymentMint: '결제 민트',
    ...
    mintShortBadge: '{{amount}} 부족',
    mintShortReason: '이 민트의 잔액으로는 수수료를 충당할 수 없어요 ({{amount}} 부족). 다른 민트를 선택해주세요.',
