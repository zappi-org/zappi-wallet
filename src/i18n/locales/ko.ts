export default {
  chat: {
    ...
    paymentCard: {
      requestTo: "{{name}}님에게 요청",
      requestFrom: "{{name}}님의 송금 요청",
      paymentTo: "{{name}}님에게 송금",
      paymentFrom: "{{name}}님의 송금 알림",
      awaitingReceipt: "수령 대기",
      noticeFailed: "송금 알림을 저장하지 못했어요. 거래 내역을 확인하세요.",
      "requestTitle": "송금 요청",
      "sendTitle": "송금",
      "noticeTitle": "송금 알림",
      openAmount: "금액 미정",
      ...
      paid: "송금 완료",
      "sent": "송금 완료",
      awaitingPayment: "송금 대기",
      awaitingIncoming: "입금 대기",
      processing: "송금 중",
      notice: "입금 미확인",
      "failed": "처리 실패",
      "expired": "만료됨",
      ...
      "opening": "여는 중…",
      details: "거래 내역",
      openFailed: "송금 화면을 열지 못했어요. 다시 시도하세요.",
},
    storageFull: "대화 저장 공간이 부족해요. 오래된 대화를 삭제하세요.",
    receiveFull: "메시지를 모두 받지 못했어요. 다시 불러오세요.",
    contextLabel: "거래 {{id}}",
    deleteConversation: '대화 삭제',
    sendMoney: '송금하기',
    blockDescription: "이 상대의 새 메시지와 알림을 차단합니다.",
    "title": "채팅",
    "newChat": "새 채팅",
    "search": "대화 검색",
    "all": "전체",
    ...
    "noResults": "검색된 대화가 없어요",
    "start": "채팅 시작",
    sayHello: "첫 메시지를 보내보세요.",
    "draft": "임시저장",
    "actions": "대화 메뉴",
    "pin": "상단에 고정",
    "unpin": "고정 해제",
    ...
    "block": "상대 차단",
    "unblock": "차단 해제",
    "blockedContacts": "차단한 상대",
    blocked: "답장하려면 채팅 목록에서 차단을 해제하세요.",
    "deleteTitle": "대화를 삭제할까요?",
    deleteDescription: "이 기기의 대화만 삭제됩니다. 상대방과 서버의 기록은 남습니다.",
    "saveFailed": "저장하지 못했어요. 다시 시도해 주세요.",
    "loadFailed": "메시지를 불러오지 못했어요",
    invalidAddress: "상대방의 올바른 주소를 입력하세요.",
    newMessage: "새 메시지",
    sendFailed: "전송하지 못했어요. 다시 시도하세요.",
    paymentRequest: "송금 요청",
    "encrypted": "종단간 암호화",
    unknownContact: "주소록에 추가",
    "older": "이전 메시지 보기",
    "newMessages": "새 메시지",
    "sent": "릴레이에 전송됨",
    "sending": "전송 중",
    "request": "요청하기",
    paymentActions: "송금·요청",
  ...
  settings: {
    ...
    verifying: '잔액 검증 중...',
    recoveringLightning: '미결제 라이트닝 복구 중...',
  ...
  notifications: {
    ...
    paymentReceived: '결제 수령됨',
    paymentSent: '결제 완료',
    tokenReceived: '토큰 수령됨',
    youReceived: '{{amount}} 수령함',
    youSent: '{{amount}} 전송함',
    justNow: '방금',
    minAgo: '{{count}}분 전',
    hourAgo: '{{count}}시간 전',
  ...
  errors: {
    ...
    lightningRouting: '라이트닝 결제 경로를 찾을 수 없습니다',
    lightningPayment: '라이트닝 결제에 실패했습니다',
    ...
    receiveRequestInvalid: '잘못된 받기 요청이에요',
  ...
  toast: {
    ...
    ecashTokenReceived: '{{amount}} 이캐시 토큰 수령 완료',
    ecashTokenReceivedWithFee: '{{amount}} 이캐시 토큰 수령 완료 (수수료: {{fee}})',
