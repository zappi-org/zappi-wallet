export default {
  ...
  kiosk: {
    ...
    scanWithLightning: 'Scan QR code with Lightning wallet',
    paymentComplete: 'Payment Complete!',
    thankYou: 'Thank you.',
    totalPaymentAmount: 'Total Payment',
    placeOrder: 'Place Order',
    pleaseWait: 'Please wait...',
    cancelOrNewOrder: 'Cancel / New Order',
    selectPaymentMethod: 'Select Payment Method',
    payWithLightning: 'Pay with Lightning',
    payWithEcash: 'Pay with Ecash',
    creatingRequest: 'Creating payment request...',
    scanWithEcash: 'Scan QR code with Ecash wallet',
    waitingEcash: 'Waiting for Ecash payment...',
    start: 'Start',
    clearCart: 'Clear Cart',
    upload: 'Upload',
    enterImageUrl: 'Enter image URL',
    productNamePlaceholder: 'e.g., Americano',
    ...
    enterPin: 'Enter PIN',
    unlockAction: 'Unlock',
    switchToBiometric: 'Switch to biometrics',
    noProductsGuide: 'Items will be available soon',
  },
