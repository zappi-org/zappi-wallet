export default {
  ...
  settings: {
    ...
    changeUsername: 'Change Lightning/Nostr Address',
    currentAddress: 'Current Address',
    newUsername: 'New Username',
    usernameAvailable: 'Available',
    usernameTaken: 'Already taken',
    usernameInvalid: '3-20 chars, lowercase and digits only',
    usernameLabel: 'User Address',
    usernameSameAddress: 'Already your current address',
    ...
    newAddressLabel: 'New user address',
    successAddressLabel: 'New address',
    changeDone: 'Your change is complete',
    changeIrreversible: 'This change cannot be refunded. Please decide carefully.',
    pay: 'Pay',
    ...
    mintShortBadge: '{{amount}} short',
    mintShortReason: 'This mint cannot cover the fee ({{amount}} short). Select another mint.',
