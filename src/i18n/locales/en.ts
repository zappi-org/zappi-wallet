export default {
  ...
  common: {
    ...
    loading: 'Loading...',
    error: 'Error',
    walletLoadErrorTitle: 'Could not load wallet',
    walletLoadErrorDescription: 'To protect your existing wallet, Zappi did not continue to new wallet setup. Please try again shortly.',
    success: 'Success',
    retry: 'Retry',
    skip: 'Skip',
    no: 'No',
  ...
  settings: {
    ...
    verifyBalance: 'Wallet Check & Recovery',
  ...
  txDetail: {
    ...
    outgoingStatus: {
      waitingClaim: 'Waiting to be claimed',
      publishedWaitingClaim: 'Sent · waiting to be claimed',
      claimed: 'Claimed',
      reclaimed: 'Reclaimed',
      publishFailed: 'Send failed',
  ...
  errors: {
    ...
    serviceNotReady: 'Still getting ready. Please try again shortly.',
