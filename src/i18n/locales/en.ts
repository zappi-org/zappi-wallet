export default {
  chat: {
    ...
    paymentCard: {
      receivedRequest: 'You received a payment request',
      receiving: 'Receiving payment',
      checkingPayment: 'Checking payment details',
      receiveFailed: 'Payment could not be received',
      pay: 'Send',
      requested: 'Payment requested',
      alreadySent: 'You already sent this payment.',
      requestTo: "Request to {{name}}",
      requestFrom: "Request from {{name}}",
      paymentTo: "Payment to {{name}}",
      paymentFrom: "Payment from {{name}}",
      awaitingReceipt: "Awaiting receipt",
      noticeFailed: "Chat notice not saved. Check transactions.",
      "requestTitle": "Payment request",
      "sendTitle": "Payment",
      "noticeTitle": "Payment notice",
      openAmount: "Amount not set",
      "received": "Payment received",
      "sent": "Payment sent",
      "processing": "Payment in progress",
      notice: "Checking receipt",
      ...
      openFailed: "Could not open the payment screen. Try again.",
},
    storageFull: "Chat storage is full. Delete older conversations and retry.",
    receiveFull: "Some messages were not received. Reload to retry.",
    contextLabel: "Trade {{id}}",
    deleteConversation: 'Delete conversation',
    sendMoney: 'Send money',
    blockDescription: "Block new messages and notifications from this person.",
    "title": "Messages",
    "newChat": "New message",
    ...
    "start": "Start chat",
    sayHello: "Send your first message.",
    "draft": "Draft",
    ...
    "block": "Block sender",
    "unblock": "Unblock",
    "blockedContacts": "Blocked senders",
    "blocked": "This sender is blocked. Unblock them from Messages to reply.",
    "deleteTitle": "Delete conversation?",
    deleteDescription: "Deletes chats on this device only. Copies on other devices and servers remain.",
    "saveFailed": "Could not save. Please try again.",
    "loadFailed": "Could not load messages",
    "invalidAddress": "Enter a valid Nostr address other than your own.",
    newMessage: "New message",
    sendFailed: "Message not sent. Try again.",
    "paymentRequest": "Payment request",
    "encrypted": "End-to-end encrypted",
    unknownContact: "Add to contacts",
    "older": "Load earlier messages",
    "newMessages": "New messages",
    "sent": "Sent to relay",
    "sending": "Sending",
    "request": "Request",
    "paymentActions": "Send or request money",
  ...
  send: {
    ...
    confirm: {
      ...
      feeUnavailable: "Could not check the fee.",
      retryFee: 'Try again',
      total: 'Total',
      send: 'Send',
