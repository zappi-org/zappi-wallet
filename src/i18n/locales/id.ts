export default {
  ...
  settings: {
    ...
    changeUsername: 'Ubah Alamat Lightning/Nostr',
    ...
    usernameLabel: 'Alamat Pengguna',
    usernameSameAddress: 'Sudah menjadi alamat kamu saat ini',
    ...
    changeConfirmTitle: 'Konfirmasi perubahan',
    newAddressLabel: 'Alamat pengguna baru',
    successAddressLabel: 'Alamat baru',
    changeDone: 'Perubahan selesai',
    changeIrreversible: 'Perubahan ini tidak dapat dikembalikan. Harap putuskan dengan hati-hati.',
    pay: 'Bayar',
    ...
    mintShortBadge: '{{amount}} kurang',
    mintShortReason: 'Mint ini tidak dapat menutup biaya (kurang {{amount}}). Pilih mint lain.',
  ...
  errors: {
    ...
    insufficientBalanceUnknown: 'Saldo tidak mencukupi setelah biaya',
  ...
  toast: {
    ...
    transferInterrupted: 'Transfer yang terputus ditandai gagal',
  ...
  send: {
    ...
    confirm: {
      ...
      fee: 'Biaya',
      feeChecking: 'Memeriksa biaya',
      feeUnavailableValue: 'Tidak tersedia',
  ...
  receive: {
    ...
    receipt: {
      ...
      memo: 'Catatan',
      completed: 'Diterima',
      receiving: 'Mengonfirmasi',
    },
    redeem: {
      title: 'Tukarkan token',
      photo: 'Dari galeri',
      paste: 'Tempel',
