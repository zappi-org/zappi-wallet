export default {
  chat: {
    ...
    paymentCard: {
      receivedRequest: 'Anda menerima permintaan pembayaran',
      receiving: 'Menerima pembayaran',
      checkingPayment: 'Memeriksa detail pembayaran',
      receiveFailed: 'Pembayaran tidak dapat diterima',
      pay: 'Kirim',
      requested: 'Pembayaran diminta',
      alreadySent: 'Kamu sudah mengirim pembayaran ini.',
      requestTo: "Permintaan kepada {{name}}",
      requestFrom: "Permintaan dari {{name}}",
      paymentTo: "Pembayaran kepada {{name}}",
      paymentFrom: "Pembayaran dari {{name}}",
      awaitingReceipt: "Menunggu diterima",
      noticeFailed: "Pemberitahuan tidak tersimpan. Periksa transaksi.",
      "requestTitle": "Permintaan pembayaran",
      "sendTitle": "Pembayaran",
      "noticeTitle": "Pemberitahuan pembayaran",
      "openAmount": "Jumlah belum ditentukan",
      "received": "Pembayaran diterima",
      "sent": "Pembayaran terkirim",
      "processing": "Pembayaran diproses",
      notice: "Memeriksa penerimaan",
      ...
      openFailed: "Tidak dapat membuka layar pembayaran. Coba lagi.",
},
    storageFull: "Penyimpanan chat penuh. Hapus percakapan lama lalu coba lagi.",
    receiveFull: "Beberapa pesan belum diterima. Muat ulang.",
    contextLabel: "Transaksi {{id}}",
    deleteConversation: 'Hapus percakapan',
    sendMoney: 'Kirim uang',
    blockDescription: "Blokir pesan baru dan notifikasi dari orang ini.",
    "title": "Pesan",
    "newChat": "Pesan baru",
    ...
    "noResults": "Percakapan tidak ditemukan",
    "start": "Mulai chat",
    "sayHello": "Sapa untuk memulai percakapan.",
    "draft": "Draf",
    "actions": "Opsi percakapan",
    "pin": "Sematkan",
    "unpin": "Lepas sematan",
    ...
    "unblock": "Buka blokir",
    "blockedContacts": "Pengirim diblokir",
    "blocked": "Buka blokir dari daftar Pesan untuk membalas.",
    "deleteTitle": "Hapus percakapan?",
    "deleteDescription": "Pesan di perangkat ini akan dihapus. Salinan penerima dan relay tetap ada.",
    "saveFailed": "Tidak dapat menyimpan. Coba lagi.",
    "loadFailed": "Tidak dapat memuat pesan",
    "invalidAddress": "Masukkan alamat Nostr yang valid selain alamat Anda sendiri.",
    newMessage: "Pesan baru",
    sendFailed: "Pesan tidak terkirim. Coba lagi.",
    "paymentRequest": "Permintaan pembayaran",
    "encrypted": "Enkripsi ujung ke ujung",
    unknownContact: "Tambahkan ke kontak",
    "older": "Muat pesan sebelumnya",
    "newMessages": "Pesan baru",
    "sent": "Terkirim ke relay",
    "sending": "Mengirim",
    "request": "Minta",
    "paymentActions": "Kirim atau minta uang",
  ...
  send: {
    ...
    confirm: {
      ...
      feeUnavailable: "Biaya tidak dapat diperiksa.",
      retryFee: 'Coba lagi',
      total: 'Total',
      send: 'Kirim',
