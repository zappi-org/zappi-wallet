export default {
  ...
  settings: {
    ...
    invalidLightningFormat: 'Format tidak valid. (contoh: user@domain.com)',
    lightningVerifyFailed: 'Tidak dapat memverifikasi Alamat Lightning.',
    invalidLightningAddress: 'Alamat Lightning tidak valid.',
    lightningValidationError: 'Validasi Alamat Lightning gagal.',
  ...
  errors: {
    ...
    insufficientBalance: 'Saldo tidak mencukupi (diperlukan: {{required}} sats, tersedia: {{available}} sats)',
