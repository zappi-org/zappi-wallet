export default {
  ...
  support: {
    ...
    heroDescription: 'Kirim permintaan bantuan secara aman ke tim Zappi dan lanjutkan percakapannya di sini.',
    connectionStatus: {
      disabled: 'Nonaktif',
      idle: 'Siaga',
    ...
    connecting: 'Menghubungkan ke bantuan',
    connectingDescription: 'Memuat riwayat bantuanmu dari relay yang dikonfigurasi.',
    connectionFailed: 'Tidak dapat terhubung ke bantuan',
    tryAgainLater: 'Silakan coba lagi nanti.',
    newTicket: 'Permintaan baru',
    startNewTicket: 'Hubungi kami',
    composePageTitle: 'Hubungi kami',
    requestTitleLabel: 'Judul',
    requestBodyLabel: 'Pesan',
    titlePlaceholder: 'Masukkan judul',
    bodyPlaceholder: 'Masukkan pesanmu',
    privacyNote: 'Jangan masukkan frasa pemulihan atau kunci privat.',
    categoryLabel: 'Jenis',
    ...
    categoryDescriptions: {
      transfer: 'Kirim & terima Lightning / ecash',
      ecash: 'Pendaftaran / pemulihan token ecash',
      fee: 'Biaya dan ongkos routing',
      security: 'Kunci, cadangan, frasa pemulihan',
      other: 'Hal lainnya',
    },
    priorities: {
      normal: 'Normal',
    ...
    priorityDescriptions: {
      normal: 'Permintaan bantuan biasa',
      high: 'Ada yang terhambat atau perlu ditinjau lebih cepat',
    },
    createTicket: 'Kirim',
    sending: 'Mengirim...',
    sendingToRelay: 'Mengirim permintaan...',
    ...
    updateFailed: 'Gagal memperbarui riwayat permintaan',
    downloadFailed: 'Gagal mengunduh file',
    myTickets: 'Permintaan saya',
    ticketCount: 'Total {{count}}',
    ...
    teamName: 'Tim Zappi',
    attachmentPreview: '{{count}} lampiran',
    ...
    downloadingAttachment: 'Mengunduh',
    filePreview: 'Mengirim sebuah file.',
    replyToast: 'Ada balasan baru di "{{title}}".',
    ticketActions: 'Opsi permintaan',
    pinTicket: 'Sematkan',
    unpinTicket: 'Lepas sematan',
    ...
    resolvedNotice: 'Permintaan ini telah diselesaikan.',
    closedNotice: 'Permintaan ini telah ditutup.',
    status: {
      open: 'Terbuka',
  ...
  settings: {
    ...
    tlsBolt11Send: 'Kirim Bolt11 (melt)',
    tlsBolt11Receive: 'Terima Bolt11 (minting)',
    tlsEcashCreate: 'Buat ecash',
    tlsEcashRedeem: 'Daftarkan ecash',
    tlsGiftWrap: 'Terima via GiftWrap',
    tlsCreq: 'Terima via Creq',
    ...
    currentWalletRecoveryDesc: 'Cari ecash yang dibuat dari frasa pemulihan dompet ini.',
    externalMnemonicRecovery: 'Impor ecash dari frasa pemulihan lain',
    externalMnemonicRecoveryDesc: 'Cari ecash dari frasa pemulihan lain dan pindahkan ke dompet ini.',
