export default {
  ...
  common: {
    ...
    loading: 'Memuat...',
    error: 'Error',
    walletLoadErrorTitle: 'Tidak dapat memuat dompet',
    walletLoadErrorDescription: 'Untuk melindungi dompet yang sudah ada, Zappi tidak melanjutkan ke pembuatan dompet baru. Coba lagi sebentar lagi.',
    success: 'Berhasil',
    retry: 'Coba Lagi',
    skip: 'Lewati',
    no: 'Tidak',
  ...
  settings: {
    ...
    verifyBalance: 'Cek & Pulihkan Dompet',
  ...
  txDetail: {
    ...
    outgoingStatus: {
      waitingClaim: 'Menunggu diklaim',
      publishedWaitingClaim: 'Terkirim · menunggu diklaim',
      claimed: 'Diklaim',
      reclaimed: 'Diklaim kembali',
      publishFailed: 'Pengiriman gagal',
  ...
  errors: {
    ...
    serviceNotReady: 'Masih menyiapkan. Coba lagi sebentar lagi.',
