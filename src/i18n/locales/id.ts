export default {
  ...
  settings: {
    ...
    noMint: 'Belum diatur',
    mintChanged: 'Mint diperbarui',
    mintChangeFailed: 'Gagal memperbarui mint',
    ...
    claimStorageTitle: 'Simpan otomatis saat kedaluwarsa',
    claimStorageDesc: 'Otomatis klaim dan simpan ecash sebelum penawaran kedaluwarsa',
    claimStorageEnabled: 'Simpan otomatis aktif',
    claimStorageDisabled: 'Simpan otomatis nonaktif',
    claimStorageStoredBalance: 'Ecash Tersimpan',
    claimNow: 'Klaim',
    claimSuccess: '{{count}} token diklaim',
