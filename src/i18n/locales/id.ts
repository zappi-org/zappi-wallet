export default {
  ...
  pos: {
    ...
    mintOfflineWarning: 'Mint offline. Token ini tidak dilindungi P2PK, orang lain mungkin menggunakannya lebih dulu. Silakan coba lagi saat mint online.',
    tokenReceiveFailed: 'Gagal menerima token.',
    tokenProcessError: 'Terjadi kesalahan saat memproses token.',
    mintTrustAddFailed: 'Gagal menambahkan kepercayaan mint.',
    untrustedMint: 'Mint tidak dipercaya',
    ...
    qrScanError: 'Error pindai QR',
    scanOrPasteToken: 'Pindai kode QR atau tempel token',
    comingSoon: 'Segera Hadir',
    nfcComingSoon: 'Penerimaan ecash via NFC segera hadir',
    waveComingSoon: 'Penerimaan ecash via gelombang suara segera hadir',
  },
  ...
  kiosk: {
    ...
    scanWithLightning: 'Pindai kode QR dengan dompet Lightning',
    paymentComplete: 'Pembayaran Selesai!',
    thankYou: 'Terima kasih.',
    totalPaymentAmount: 'Total Pembayaran',
    placeOrder: 'Pesan Sekarang',
    pleaseWait: 'Mohon tunggu...',
    cancelOrNewOrder: 'Batal / Pesanan Baru',
    selectPaymentMethod: 'Pilih Metode Pembayaran',
    payWithLightning: 'Bayar dengan Lightning',
    payWithEcash: 'Bayar dengan Ecash',
    creatingRequest: 'Membuat permintaan pembayaran...',
    scanWithEcash: 'Pindai kode QR dengan dompet Ecash',
    waitingEcash: 'Menunggu pembayaran Ecash...',
    start: 'Mulai',
    clearCart: 'Kosongkan Keranjang',
    upload: 'Unggah',
    enterImageUrl: 'Masukkan URL gambar',
    productNamePlaceholder: 'Contoh: Americano',
    priceSats: 'Harga (sats)',
    category: 'Kategori',
    none: 'Tidak ada',
    createNew: 'Buat Baru',
    newCategoryName: 'Nama kategori baru',
    imageSizeLimit: 'Ukuran gambar maksimal 5MB.',
    enterProductName: 'Mohon masukkan nama produk.',
    enterValidPrice: 'Mohon masukkan harga yang valid.',
    adminUnlock: 'Buka Kunci Admin',
    authFailed: 'Autentikasi gagal.',
    wrongPin: 'PIN salah.',
    biometricUnlock: 'Buka kunci dengan biometrik',
    useBiometric: 'Gunakan autentikasi biometrik',
    enterPin: 'Masukkan PIN',
    unlockAction: 'Buka Kunci',
    switchToBiometric: 'Beralih ke biometrik',
    noProductsGuide: 'Produk akan segera tersedia',
  },
